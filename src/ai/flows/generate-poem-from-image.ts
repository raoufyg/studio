...
const prompt = ai.definePrompt({
  ...
  prompt: `أنت خبير في الشعر العربي الكلاسيكي. بناءً على الصورة المعطاة، قم بإنشاء قصيدة باللغة العربية الفصحى تعكس أسلوب الشعر {{$style}}. يجب أن تكون القصيدة متناسبة مع الصورة من حيث الموضوع والشعور، وأن تتبع القواعد التقليدية للشعر العربي من حيث الوزن والقافية. يجب أن تحافظ على شكل القصيدة الأصلي بحيث تكتب على شكل أبيات.\n\nImage: {{media url=photoDataUri}}`,
});
